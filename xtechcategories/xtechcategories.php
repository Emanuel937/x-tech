...
class Xtechcategories extends Module
{
    public function __construct()
    {
        $this->name = 'xtechcategories';
        $this->version = '1.0.1';
        ...
        $this->displayName = $this->l('X-tech Categories');
    ...
    public function install()
    {
        return parent::install()
            && $this->registerHook('displayCategoryHome') ;
        
    }

    public function uninstall()
    {
        return parent::uninstall() && Configuration::deleteByName('XTECH_SELECTED_CATEGORIES');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitXtechCategories')) {
            ...
            Configuration::updateValue('XTECH_SELECTED_CATEGORIES', json_encode($selectedCategories));
    ...
    private function renderForm()
    {
        ...
        $tree->setRootCategory(Category::getRootCategory()->id)
             ->setUseCheckBox(true)
             ->setSelectedCategories(json_decode(Configuration::get('XTECH_SELECTED_CATEGORIES'), true) ?? []);
    ...
    public function hookDisplayCategoryHome()
    {
